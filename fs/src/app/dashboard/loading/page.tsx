...
const Page = () => {
  ...
  return (
    <>
      ...
      <div className="flex w-full flex-1 items-center justify-center px-4 py-20 relative">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 text-center max-w-lg">
          ...
          <Heading>Processing your File...</Heading>
          <p className="text-base text-gray-600">
            Just a moment, the model is analyzing your data.
          </p>
        </div>
      </div>
